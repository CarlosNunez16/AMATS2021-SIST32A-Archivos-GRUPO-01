<h1 class="text-center m-3 fs-2">MANTENIMIENTOS</h1>
<?php
echo "
    ...
    <div class='row d-flex justify-content-center'>
        <div class='row d-flex justify-content-center'>
            <div class='col-5'>
                <a href='imprimir.php?tabla=EnMantenimientoMy' target='_blank' class='btn btn-secondary' title='IMPRIMIR'>
...
<h1 class='text-center m-3 fs-4'>TODOS LOS MANTENIMIENTOS</h1>
<div class="row d-flex justify-content-center">
...
if(isset($_POST["buscar"]))
{
	$dato = $_POST["dato"];
	echo "
    <h1 class='text-center m-3 fs-4'>TODOS LOS MANTENIMIENTO</h1>
    <div class='row d-flex justify-content-center'>
